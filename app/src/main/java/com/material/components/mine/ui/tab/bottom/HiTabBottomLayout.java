package com.material.components.mine.ui.tab.bottom;
...
import com.material.components.mine.HiDisplayUtil;
import com.material.components.mine.HiViewUtil;
import com.material.components.mine.ui.tab.common.IHiTabLayout;
...
public class HiTabBottomLayout extends FrameLayout implements IHiTabLayout<HiTabBottom, HiTabBottomInfo<?>> {
    ...
    private void fixContentView() {
        ...
        if (rootView != null) {
            rootView.setPadding(0, 0, 0, HiDisplayUtil.dp2px(tabBottomHeight, getResources()));
